...
public:
	 ...
	 */
	HashMap<int, Souvenir>& getSouvenirs();
	...
	/**
	 * @author Aaron Geesink
	 * @brief setSouvenirs(HashMap<int, Souvenir> souvenirs)
	 * Sets the souvenirs for a team to a map of Souvenir objects
	 * @param HashMap<int, Souvenir> souvenirs
	 */
	void setSouvenirs(HashMap<int, Souvenir> souvenirs);
...
private:
	...
	//HashMap<int, Souvenir> souvenirs;	/// The souvenirs for a team
	HashMap<int, Souvenir> souvenirs;	/// Souvenirs for a team
